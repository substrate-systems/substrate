...
- `src/lib/exomem-hosted/provisioner.ts`, reconciler and lifecycle-store boundaries, candidate catalog binding, focused tests, migration `0037`, environment contracts, runbooks, and the active `add-exomem-hosted-mcp-oauth` artifacts.
