...
- Cross-repo follow-up: `endstate-gui` still labels its section "Hosted Backup".
  Two strings here name that label on purpose and flip when the GUI renames —
  tracked in `docs/naming.md`.
