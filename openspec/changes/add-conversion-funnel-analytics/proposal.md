...
- **Cross-boundary identity threading.** `distinct_id` carried through Paddle `customData` and appended to the `endstate://claim` deep link, joining the web session to the checkout and to the desktop app.
