...
- **WHEN** the source or derived state names a non-reviewer tenant, a restore or incomplete operation, another fence, more than one live cell, a cell not exactly bound and routable with `CELL_READY`, an active assignment or authority, or another unfinished operation
