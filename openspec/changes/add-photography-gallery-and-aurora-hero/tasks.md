...
- [x] 5.3 Preserve the canonical logo and copy as foreground elements and verify WCAG AA contrast.
...
- [x] 5.9 Replace the hero secondary line with `Owned machines. Durable memory. Source-grounded AI.` and verify its responsive wrapping does not crowd the hero hierarchy or `Explore ↓`.

## 6. Homepage Narrative and Motion

- [x] 6.1 Rewrite the Hook section with the approved control-and-continuity thesis.
- [x] 6.2 Replace the abstract Philosophy axioms with the approved setup/memory/sources sequence in normal document flow.
...
- [x] 7.2 Run `npm run openspec:validate` and `npm run build`.
