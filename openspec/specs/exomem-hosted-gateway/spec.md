# exomem-hosted-gateway Specification

## Purpose

Define authenticated tenant routing, registry-derived command forwarding, scoped transfer authority, and cross-tenant isolation at the public gateway.
