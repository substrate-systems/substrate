# exomem-home Specification

## Purpose

Define the private hosted workspace, non-technical onboarding journey, memory interactions, and safe account controls for Exomem owners.
