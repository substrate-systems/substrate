...
describe("hosted operator controls", () => {
  it("stages a virgin bootstrap authority against the exact 0.89.0 gateway contract", async () => {
    ...
    assert.equal(values.includes(exomemContractFixture0890.release), true);
