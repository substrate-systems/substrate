...
import { exomemHostedContractFixture as agentFixture0890 } from "../agent-contract-fixture";
import { exomemHostedContractFixture as agentFixture0770 } from "../agent-contract-fixture-0-77-0";
...
import { exomemHostedContractFixture as agentFixture0680 } from "../agent-contract-fixture-0-68-0";
import { exomemHostedContractFixture as agentFixture0681 } from "../agent-contract-fixture-0-68-1";
...
import fullContract0681 from "./gateway-contract-0-68-1.json";
...
import fullContract0740 from "./gateway-contract-0-74-0.json";
import fullContract0770 from "./gateway-contract-0-77-0.json";
import fullContract0890 from "./gateway-contract-0-89-0.json";
...
const FULL_CONTRACT_0681 = fullContract0681 as TestContract;
const FULL_CONTRACT_0683 = fullContract0683 as TestContract;
const FULL_CONTRACT_0721 = fullContract0721 as TestContract;
const FULL_CONTRACT_0731 = fullContract0731 as TestContract;
const FULL_CONTRACT_0740 = fullContract0740 as TestContract;
const FULL_CONTRACT_0770 = fullContract0770 as TestContract;
const FULL_CONTRACT_0890 = fullContract0890 as TestContract;
...
const RETAINED_0680_HOSTED_CONTRACT = {
...
const RETAINED_0681_HOSTED_CONTRACT = {
  profile: agentFixture0681.compatibility.profile,
  sourceRelease: agentFixture0681.sourceRelease,
  protocolVersion: agentFixture0681.compatibility.agent_contract.protocol_version,
  commandFingerprint: agentFixture0681.compatibility.command_surface_sha256,
  schemaDigest: agentFixture0681.compatibility.schema_contract_sha256,
  compatibilityDigest: agentFixture0681.compatibility.compatibility_sha256,
};
const RETAINED_0683_HOSTED_CONTRACT = {
  profile: agentFixture0683.compatibility.profile,
  sourceRelease: agentFixture0683.sourceRelease,
  protocolVersion: agentFixture0683.compatibility.agent_contract.protocol_version,
  commandFingerprint: agentFixture0683.compatibility.command_surface_sha256,
  schemaDigest: agentFixture0683.compatibility.schema_contract_sha256,
  compatibilityDigest: agentFixture0683.compatibility.compatibility_sha256,
};
const RETAINED_0721_HOSTED_CONTRACT = {
  profile: agentFixture0721.compatibility.profile,
  sourceRelease: agentFixture0721.sourceRelease,
  protocolVersion: agentFixture0721.compatibility.agent_contract.protocol_version,
  commandFingerprint: agentFixture0721.compatibility.command_surface_sha256,
  schemaDigest: agentFixture0721.compatibility.schema_contract_sha256,
  compatibilityDigest: agentFixture0721.compatibility.compatibility_sha256,
};
const CURRENT_HOSTED_CONTRACT = {
  profile: agentFixture0890.compatibility.profile,
  sourceRelease: agentFixture0890.sourceRelease,
  protocolVersion: agentFixture0890.compatibility.agent_contract.protocol_version,
  commandFingerprint: agentFixture0890.compatibility.command_surface_sha256,
  schemaDigest: agentFixture0890.compatibility.schema_contract_sha256,
  compatibilityDigest: agentFixture0890.compatibility.compatibility_sha256,
};
...
describe("registry-derived Exomem gateway", () => {
  ...
  it("keeps live and candidate agent contracts paired with their own full fixtures", async () => {
    for (const [releaseVersion, hosted] of [
      ...
      ["0.68.0", RETAINED_0680_HOSTED_CONTRACT],
      ["0.68.1", RETAINED_0681_HOSTED_CONTRACT],
      ["0.68.3", RETAINED_0683_HOSTED_CONTRACT],
      ["0.72.1", RETAINED_0721_HOSTED_CONTRACT],
      [
        "0.73.1",
        {
          profile: agentFixture0731.compatibility.profile,
          sourceRelease: agentFixture0731.sourceRelease,
          protocolVersion: agentFixture0731.compatibility.agent_contract.protocol_version,
          commandFingerprint: agentFixture0731.compatibility.command_surface_sha256,
          schemaDigest: agentFixture0731.compatibility.schema_contract_sha256,
          compatibilityDigest: agentFixture0731.compatibility.compatibility_sha256,
        },
      ],
      [
        "0.74.0",
        {
          profile: agentFixture0740.compatibility.profile,
          sourceRelease: agentFixture0740.sourceRelease,
          protocolVersion: agentFixture0740.compatibility.agent_contract.protocol_version,
          commandFingerprint: agentFixture0740.compatibility.command_surface_sha256,
          schemaDigest: agentFixture0740.compatibility.schema_contract_sha256,
          compatibilityDigest: agentFixture0740.compatibility.compatibility_sha256,
        },
      ],
      [
        "0.77.0",
        {
          profile: agentFixture0770.compatibility.profile,
          sourceRelease: agentFixture0770.sourceRelease,
          protocolVersion: agentFixture0770.compatibility.agent_contract.protocol_version,
          commandFingerprint: agentFixture0770.compatibility.command_surface_sha256,
          schemaDigest: agentFixture0770.compatibility.schema_contract_sha256,
          compatibilityDigest: agentFixture0770.compatibility.compatibility_sha256,
        },
      ],
      ["0.89.0", CURRENT_HOSTED_CONTRACT],
    ] as const) {
      const row = target({
        userId: USER_A,
        tenantId: TENANT_A,
  ...
  for (const [label, hosted, full] of [
    ["current 0.89.0", CURRENT_HOSTED_CONTRACT, FULL_CONTRACT_0890],
    [
      "retained 0.77.0",
      {
        profile: agentFixture0770.compatibility.profile,
    ...
    ["retained 0.72.1", RETAINED_0721_HOSTED_CONTRACT, FULL_CONTRACT_0721],
    ["retained 0.68.3", RETAINED_0683_HOSTED_CONTRACT, FULL_CONTRACT_0683],
    ["retained 0.68.1", RETAINED_0681_HOSTED_CONTRACT, FULL_CONTRACT_0681],
    ["retained 0.68.0", RETAINED_0680_HOSTED_CONTRACT, FULL_CONTRACT_0680],
