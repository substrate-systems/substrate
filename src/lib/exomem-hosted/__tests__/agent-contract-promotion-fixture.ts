...
import { exomemHostedContractFixture as retainedFixture0740 } from "../agent-contract-fixture-0-74-0";
import { exomemHostedContractFixture as retainedFixture0770 } from "../agent-contract-fixture-0-77-0";
...
export function promotionContractFixture(release: PromotionFixtureRelease) {
  ...
  if (release === "0.74.0") return retainedFixture0740;
  return release === "0.77.0" ? retainedFixture0770 : liveFixture;
}
...
export function testOpenAiLocks(
  ...
  if (release === "0.89.0" && digests === undefined) {
    return {
