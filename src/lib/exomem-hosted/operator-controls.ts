    ...
    const { rows } = await tx`
      ...
      WITH invite AS (
        ...
        JOIN exomem_agent_contract_candidates AS candidate
         ...
         AND candidate.profile_id = 'hosted-alpha-agent-v1'
         AND candidate.source_release = ${exomemContractFixture0500.release}
         AND candidate.protocol_version = ${exomemContractFixture0500.protocol}
        ...
        SELECT 'active', invite.id, stage.candidate_id, stage.profile_id, stage.contract_sha256,
               stage.source_release, stage.protocol_version, ${exomemContractFixture0500.digest},
