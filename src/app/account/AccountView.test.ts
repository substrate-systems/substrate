...
describe("scheduled cancellation presentation", () => {
  ...
  it("uses the authoritative retention deadline after cancellation", () => {
    assert.equal(
      dateLineText({
        status: "cancelled",
        periodEnd: "August 14, 2026",
        graceEnd: null,
        retentionEnd: "September 13, 2026",
        scheduledCancelAt: null,
      }),
      "Cancelled. Existing backups remain accessible through September 13, 2026."
    );
  });
