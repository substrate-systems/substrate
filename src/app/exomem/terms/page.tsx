...
export const metadata: Metadata = {
  ...
  description: "Terms for the invite-only Exomem Hosted service from Substrate Systems OÜ.",
};

export default function ExomemTermsPage() {
  return (
    <ExomemPublicPage title="Exomem Hosted terms" eyebrow="Revised 28 July 2026">
      <p>
        ...
        you accept an invitation, create an account, or use the Hosted service. The open-source
        Exomem software remains governed by the license in its repository.
      </p>

      <h2>Eligibility and private alpha</h2>
      <p>
        Hosted Exomem is invite-only during the private alpha. You must be legally able to enter
        this agreement, provide accurate account information, keep access to your email and
        connected clients secure, and promptly tell us about suspected unauthorized use. An invite
        is personal and may not be sold or transferred.
      </p>
      ...
      <p>
        ...
        as Anthropic and OpenAI and remain subject to their terms. We may change alpha features,
        limits, compatible clients, or infrastructure as the service develops. We do not promise a
        service-level agreement during the private alpha, but we will operate the service with
        reasonable care and communicate material changes where practicable.
      </p>
      ...
      <p>
        The complimentary private alpha has no subscription fee. If a paid plan is offered later,
        its price, renewal period, taxes, cancellation, and refund terms will be shown before
        purchase, and Paddle will act as merchant of record. You can stop using the service,
        disconnect clients, export your canonical data, and request verified account deletion.
        Ending access does not erase information already sent to a third-party client; manage that
        information with the client provider.
      </p>
      ...
      <p>
        The private alpha is provided on an as-available basis. To the extent permitted by law, we
      ...
      <p>
        You may terminate by requesting deletion. We may end an invitation or account for material
        breach, security risk, legal requirement, or discontinuation of the alpha. Provisions that
