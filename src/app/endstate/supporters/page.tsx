  ...
  return (
    <>
      ...
      >
        ...
        <section id="support" className="py-24 px-6" style={{ borderTop: `1px solid ${c.border}` }}>
          <div className="mx-auto" style={{ maxWidth: 680 }}>
            <p
              style={{
                fontFamily: "var(--font-jetbrains-mono), monospace",
            ...
            >
              ...
              product is already the whole product. If Endstate saved you a rebuild and you want it
              to keep going, this is the way to say so.
            </p>
