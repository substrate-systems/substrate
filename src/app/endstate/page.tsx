...
function Pricing() {
  ...
  const hostedBackupCtaLabel =
    hostedBackupCadence === "monthly" ? "Get Endstate Cloud — €4/mo" : "Get Endstate Cloud — €40/yr";
  ...
  const tiers: PricingTier[] = [
    ...
    },
    {
      ...
      blurb:
        "Your encrypted setup history, kept current automatically. Local by default. Cloud only by choice.",
      features: [
        "Encrypted before it leaves your machine",
        "Client-side keys — Endstate cannot read your data",
        "Optional automatic backup after each capture",
    ...
    },
    {
      ...
      blurb: "Cloud backups and shared profiles for teams setting up multiple machines.",
      features: [
        "Everything in Endstate Cloud",
