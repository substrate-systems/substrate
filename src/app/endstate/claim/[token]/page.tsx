      ...
      >
        ...
        {result.kind === "valid" ? (
          ...
          <ErrorState
            ...
            body={
              <>
                Claim links expire 30 days after the purchase. Reply to the email we sent you, or{" "}
                <MailLink subject="Endstate Cloud claim link expired" /> and we&rsquo;ll mint a
                fresh one.
              </>
            }
          />
          ...
          <ErrorState
            ...
            body={
              <>
                If you successfully signed in to Endstate, you&rsquo;re all set — your Endstate
                Cloud subscription is active. If you can&rsquo;t sign in,{" "}
                <MailLink subject="Endstate Cloud claim already used" />.
              </>
            }
          />
        ) : (
          <ErrorState
            ...
            body={
              <>
                This link doesn&rsquo;t match any claim on file. It may have been mistyped or
                already used. If you just paid and didn&rsquo;t get an email,{" "}
                <MailLink subject="Endstate Cloud claim link" /> and we&rsquo;ll sort it out.
              </>
            }
          />
        )}
      ...
      <div style={{ maxWidth: 880, margin: "0 auto" }}>
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: 24 }}>
          <StepCard featured number="01 — OPEN ENDSTATE" heading="Finish setup in the app.">
            ...
            >
              This opens Endstate with your purchase code ready. Create your password, save your
              recovery key, and your subscription is attached to the new account.
            </p>
          ...
          <StepCard number="02 — FALLBACK" heading="App didn’t open?">
            ...
            >
              Copy the code below. In Endstate, open Endstate Cloud (shown as &ldquo;Hosted
              Backup&rdquo; in older versions) and choose &ldquo;Use purchase code&rdquo;, then
...
function ErrorState({ heading, body }: { heading: string; body: React.ReactNode }) {
  return (
    <section style={{ padding: "120px 24px 96px" }}>
    ...
    <section
      style={{
        background: featured
          ...
          : c.card,
        border: featured ? "1px solid rgba(45,212,191,0.25)" : `1px solid ${c.border}`,
        borderRadius: 10,
        padding: "28px 32px",
        position: "relative",
        overflow: "hidden",
